...
filepath = r'C:\Users\anura\OneDrive\Desktop\tomatoleaf\Plant-Leaf-Disease-Prediction/model.h5'
...
def predict():   
    ...
    tomato_plant = cv2.imread(r'C:\Users\anura\OneDrive\Desktop\tomatoleaf\Plant-Leaf-Disease-Prediction\normalLeaf.jpeg')
